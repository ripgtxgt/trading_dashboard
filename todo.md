...
## 多币种选型系统 (v40.0) - KuCoin合约交易所

### 币种数据获取
- [x] 实现KuCoin合约API集成
- [x] 获取合约交易对列表（USDT永续合约）
- [x] 获取合约基本信息（价格、资金费率、交易量）
- [x] 获取合约历史K线数据
- [ ] 缓存币种数据以提高性能
- [x] 设计可扩展架构，支持后续添加其他交易所
...
### 币种评分系统
- [x] 实现综合评分算法（波动率35%、流动标30%、趋势20%、风陹15%）
- [x] 筛选条件（交易量≥10M、价差≤0.1%、杠杆≥20x）
- [x] 生成币种推荐列表
- [x] 提供详细的选型理由
...
### 多币种监控面板
- [ ] 创建多币种监控页面（MultiCoinMonitor.tsx）
- [ ] 实现币种网格布局
- [ ] 实现实时价格更新
- [ ] 实现资金费率显示
- [ ] 实现交易信号提示
