              ...
              <div className="flex items-center gap-1 md:gap-2">
                <Link href="/coin-selector">
                  <Button variant="outline" size="sm" className="h-8 text-xs md:text-sm">
                    <Coins className="h-3.5 w-3.5 md:h-4 md:w-4 md:mr-2" />
                    <span className="hidden md:inline">币种选择</span>
                  </Button>
                </Link>
                <Link href="/multi-coin-monitor">
                  <Button variant="outline" size="sm" className="h-8 text-xs md:text-sm">
                    <Activity className="h-3.5 w-3.5 md:h-4 md:w-4 md:mr-2" />
                    <span className="hidden md:inline">多币种</span>
                  </Button>
                </Link>
                <Link href="/history">
                  <Button variant="outline" size="sm" className="h-8 text-xs md:text-sm">
                    <History className="h-3.5 w-3.5 md:h-4 md:w-4 md:mr-2" />
                    <span className="hidden md:inline">历史</span>
                  </Button>
                </Link>
                <Link href="/risk-analysis">
                  <Button variant="outline" size="sm" className="h-8 text-xs md:text-sm">
                    <TrendingDown className="h-3.5 w-3.5 md:h-4 md:w-4 md:mr-2" />
                    <span className="hidden md:inline">风险</span>
                  </Button>
                </Link>
              </div>
